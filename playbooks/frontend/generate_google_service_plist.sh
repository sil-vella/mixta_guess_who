#!/bin/bash
# Generates mixta_flutter/macos/Runner/GoogleService-Info.plist from repo root .env.local
...
PLIST_PATH="$REPO_ROOT/mixta_flutter/macos/Runner/GoogleService-Info.plist"
